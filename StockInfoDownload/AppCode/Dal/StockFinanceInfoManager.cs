...
namespace Dal
{
    class StockFinanceInfoManager
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Model.StockFinanceInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into StockFinanceInfo(");
            strSql.Append("Type,Code,GBLT,SSSF,SSHY,CWUpdateTime,ListingDate,AllGB,GJG,FQRFRG,FRG,BG,HG,ZhGG,AllZC,LDZC,GDZC,WXZC,GDRS,LDFZ,CQFZ,ZBGJJ,JZC,ZYSR,ZYLR,YSZK,YYLR,TZSY,JYXJL,ZXJL,CH,LRZE,SHLR,JLR,WFLR,Unknow1,unknow2)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.StockFinanceInfo model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.StockFinanceInfo GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,Type,Code,GBLT,SSSF,SSHY,CWUpdateTime,ListingDate,AllGB,GJG,FQRFRG,FRG,BG,HG,ZhGG,AllZC,LDZC,GDZC,WXZC,GDRS,LDFZ,CQFZ,ZBGJJ,JZC,ZYSR,ZYLR,YSZK,YYLR,TZSY,JYXJL,ZXJL,CH,LRZE,SHLR,JLR,WFLR,Unknow1,unknow2 from StockFinanceInfo ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
            ...
            Model.StockFinanceInfo model = new Model.StockFinanceInfo();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.StockFinanceInfo DataRowToModel(DataRow row)
        {
            Model.StockFinanceInfo model = new Model.StockFinanceInfo();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,Type,Code,GBLT,SSSF,SSHY,CWUpdateTime,ListingDate,AllGB,GJG,FQRFRG,FRG,BG,HG,ZhGG,AllZC,LDZC,GDZC,WXZC,GDRS,LDFZ,CQFZ,ZBGJJ,JZC,ZYSR,ZYLR,YSZK,YYLR,TZSY,JYXJL,ZXJL,CH,LRZE,SHLR,JLR,WFLR,Unknow1,unknow2 ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,Type,Code,GBLT,SSSF,SSHY,CWUpdateTime,ListingDate,AllGB,GJG,FQRFRG,FRG,BG,HG,ZhGG,AllZC,LDZC,GDZC,WXZC,GDRS,LDFZ,CQFZ,ZBGJJ,JZC,ZYSR,ZYLR,YSZK,YYLR,TZSY,JYXJL,ZXJL,CH,LRZE,SHLR,JLR,WFLR,Unknow1,unknow2 ");
            strSql.Append(" FROM StockFinanceInfo ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
